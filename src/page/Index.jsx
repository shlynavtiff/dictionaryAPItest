...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full mt-10 flex justify-center bg-borat text-white">
      <div className='max-w-screen-lg w-full p-4'>
        ...
        <div className='flex justify-between flex-row'>
          ...
          <div className='flex mb-5 flex-row text-xs justify-end items-center'>
            pokingina
          </div>
        </div>
        ...
        <div className='flex flex-col items-center'>
          <form onSubmit={handleSubmit} className="relative w-full px-5 items-center">
            <input
              ...
              value={word} // Set the input value to match the word state
              type="text"
              name="wordInput"
              placeholder="Search..."
